...
draw_text_color(0,160,"Game Started: " + string(global.gameStarted),c_white,c_white,c_white,c_white,1);
draw_text_color(0,180,"Game Paused: " + string(global.gamePaused),c_white,c_white,c_white,c_white,1);
